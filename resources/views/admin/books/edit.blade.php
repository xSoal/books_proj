    ...
    <div class="form_block_items form_add form_edit">
        ...
        <form action="{{ route('admin.postBooks') }}" method="POST"  autocomplete="off">
            ...
            <div class="tabPagesHeaderCont">
                <div class="tabPagesHeader active">
                    Характеристики та теги
                </div>
            ...
            <div class="tabPagesBodyCont">
                <div class="tabBody__page show" data-index="0">
                ...
                <div class="tabBody__page" data-index="1">
                    <div class="langsForm">
                        ...
                        <div class="langsForm__body">
                            ...
                            @for ($i = 0; $i < count($languages); $i++)
                                <div class="langsForm__langFields {{ $i === 0 ? 'show' : '' }}">
                                    @foreach($book_static_fields as $field_name => $field)
                                        @if($field['type'] === 'input')
                                            <div class="form_block">
                                                <div class="fb_inside">
                                                    <div class="fb_label">
                                                        <div class="fb_label_inside">
                                                            <label for="{{ $field_name }}_{{ $languages[$i] }}">{{ $field['name'] }} {{ $languages[$i] }}</label>
                                                        </div>
                                                    </div>
                                                    <div class="fb_input">
                                                        <div class="fb_input_inside">
                                                            <input
                                                                type="text" 
                                                                name="{{ $field_name }}[{{ $languages[$i] }}]" 
                                                                value="{{ $item->translates[$languages[$i]][$field_name] ?? '' }}" 
                                                                id="{{ $field_name }}_{{ $languages[$i] }}" 
                                                    ...
                                                    <div class="fb_input">
                                                        <div class="fb_input_inside">
                                                            <textarea 
                                                                ...
                                                                id="{{ $field_name }}_{{ $languages[$i] }}"
                                                                cols="30"
                                                                rows="10">{{ $item->translates[$languages[$i]][$field_name] ?? '' }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>                                
                                            </div>
