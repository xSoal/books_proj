...
<section class="users_list main_section active">
    ...
    <div class="search_block">
        <div class="search_form">
            <form action="{{ route('admin.postBooks') }}" method="POST" class="for_search">
				{{ csrf_field() }}
                <div class="form_block fb_query">
                    <div class="fb_inside">
                        <div class="fb_label">
                            <div class="fb_label_inside label_search">
                                <label for="search_users">Назва, анотація, slug</label>
                            </div>
                        </div>
                        <div class="fb_input">
        ...
        <div class="add_new_item">
            <a href="{{ route('admin.addBook') }}" class="add_item">Додати</a>
        </div>
    ...
    <div class="table">
        ...
        <div class="tbody">
            @if( $items )
			    @foreach($items as  $k => $item)
                    <div class="tr_block" data-id="{{ $item->id }}" data-type="book">
                        <div class="tr tr_values">
                            ...
                            <div class="td edit">
                                <a href="{{ route('admin.viewBook', ['id' => $item->id]) }}" class="edit_link">
                                    <span>
