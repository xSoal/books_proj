...
<section class="users_list main_section active">
    ...
    <div class="search_block">
        <div class="search_form">
            <form action="{{ route('admin.postCharacteristics') }}" method="POST" class="for_search">
				{{ csrf_field() }}
        ...
        <div class="add_new_item">
            <a href="{{ route('admin.addCharacteristic') }}" class="add_item">Додати</a>
        </div>
        ...
        <div class="tbody">
            @if( $items )
			    @foreach($items as  $k => $item)
                    <div class="tr_block" data-id="{{ $item->id }}" data-type="characteristic">
                        <div class="tr tr_values">
                            ...
                            <div class="td edit">
                                <a href="{{ route('admin.viewCharacteristic', ['id' => $item->id]) }}" class="edit_link">
                                    <span>
